...
import (
	...
	"github.com/PenF00k/go-wand/generator/dart"
	"github.com/PenF00k/go-wand/generator/gocall"
	"github.com/PenF00k/go-wand/generator/proto"
	"go/ast"
	"go/parser"
	"go/token"
	"os/exec"
...
func Parse(codeList *generator.CodeList, genDartDto bool, skipGenDart bool) {
	...
	if hasChanges(codeList, &oldState) {
		...
		if genDartDto {
			//leave after we generated dart if needed
			return
		}
